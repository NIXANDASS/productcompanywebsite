...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="productitem"> 
        <div class="itemimage">
        <img src="/static/img/leebyungchul.png"  alt="product image">
      </div>
      ...
      <div class="productitem"> 
        <div class="itemimage">
        <img src="/static/img/leijun.png"  alt="product image">
      </div>
      <div class="itemname">CEO
           <br>
           (Leijun)
      ...
      <div class="productitem"> 
        <div class="itemimage">
        <img src="/static/img/petelau.png"  alt="product image">
      </div>
       <div class="itemname">CEO
           <br>
           (Petelau)
      ...
      <div class="productitem"> 
        <div class="itemimage">
        <img src="/static/img/shenwei.png"  alt="productimage">
      </div>
       <div class="itemname">CEO
           <br>
           (Shenwei)
      ...
      <div class="productitem"> 
        <div class="itemimage">
        <img src="/static/img/skyli.png"  alt="product image">
      </div>
       <div class="itemname">CEO
           <br>
           (Skyli)
    ...
    <div class="container">
      ...
      <div class="content">
          <ul>
              ...
              <li>Contact:6369341059;<br></li>
              <li>dassnixan@gmail.com<br></li>
              <br>VERIFIED*
          </ul>    
        </div>
    </div>
      ...
      <div class="footer">
        Copyright @ 2023 MOBILE WEBSITE, BY A NIXAN DASS
      </div>
    </div>
  </body>
</html> 
